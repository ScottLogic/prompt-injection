		...
		>
			...
			{currentPage === 2 && (
				<div className="content">
					...
					<span className="speaker-text">
					<h2>Your mission</h2>
					<p>You have joined the popular soft drink producer ScottBrew as a developer, but have actually been hired by their largest competitor to steal the ScottBrew recipe.</p>
					<h3>But first:</h3>
					<p>
